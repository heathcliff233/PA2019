...
static OpcodeEntry load_table [8] = {
  EXW(ldd,4), EXW(ldd,4), EXW(ld, 4), EMPTY, EXW(ld,4), EXW(ld,4), EXW(ld,4), EMPTY
};
...
static OpcodeEntry store_table [8] = {
  EXW(st,4), EMPTY, EXW(st, 4), EMPTY, EMPTY, EMPTY, EMPTY, EMPTY
};
...
static OpcodeEntry mathi_table [8] = {
  EXW(addi,4), EXW(slli,4), EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY
};
...
static OpcodeEntry opcode_table [32] = {
  /* b00 */ IDEX(ld, load), EMPTY, EMPTY, EMPTY, IDEX(Addi,mathi), IDEX(U,auipc), EMPTY, EMPTY,
